...
public class MainActivity2 extends AppCompatActivity {
    ...
    private void   AnhXa() {
        ...
        arrayBongDa.add(new BongDa("Hồ Quang Hiếu","Việt Nam ",R.drawable.hoquanghieu));
        arrayBongDa.add(new BongDa("Chi Dân ","Trung Quốc ",R.drawable.chidan));
        arrayBongDa.add(new BongDa("Du Thiên","Thái Lan",R.drawable.duthien));
        arrayBongDa.add(new BongDa("Xack Grealish","Vương Quốc Anh",R.drawable.xack));
        arrayBongDa.add (new BongDa("Eril ","Việt Nam ",R.drawable.erik));
